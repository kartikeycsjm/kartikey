...
const skill = ({name,img,text}) => {
  return (
    <div className='md:flex-col md:min-h-[250px] md:w-[300px] md:h-[300px] border border-blue-700 my-1 h-[150px] w-[100%] flex items-center justify-around rounded-lg bg-blue-800'>
