    ...
    return (
        ...
        justify-between md:justify-between bg-[rgba(0,0,0,0.95)] text-[rgb(255,255,255)]'>
            <div className='w-[40%] sm:w-[45%] md:w-[30%] h-full flex justify-between items-center'>
                <Image src={img} className='w-[70px] md:w-[90px] rounded-full'></Image>
                <h1 id='n' className=' cursor-pointer text-[25px] sm:text-[30px] md:text-[35px] text-[#e0e0fc]'>&lt;Kartikey/&gt;</h1>
            </div>
